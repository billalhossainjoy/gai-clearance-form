...
const ClearanceForm: React.FC<InfoProps> = ({ info, data: tableData }) => {
            ...
            <View style={styles.table}>
              ...
              {tableData?.map((dept) => (
                <View key={Math.random()} style={styles.tableRow}>
                  <View style={styles.tableColId}>
                    <Text style={styles.tableCell}>{dept.serial}</Text>
                  </View>
                  <View style={styles.tableColDept}>
                  ...
                  <View style={styles.tableColSign}>
                    <View style={styles.imageContainer}>
                      {dept.sign1 && dept.sign1.length > 50 ? (
                        <Image src={dept.sign1} style={styles.image} />
                      ) : null}
                    </View>
                  </View>
                  <View style={styles.tableColSign}>
                    <View style={styles.imageContainer}>
                      {dept.sign2 && dept.sign2.length > 50 ? (
                        <Image src={dept.sign2} style={styles.image} />
                      ) : null}
                    </View>
                  </View>
                  <View style={styles.tableColSign}>
                    <View style={styles.imageContainer}>
                      {dept.sign3 && dept.sign3.length > 50 ? (
                        <Image src={dept.sign3} style={styles.image} />
                      ) : null}
                    </View>
                  </View>
                </View>
